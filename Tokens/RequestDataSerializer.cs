...
{
    /// <summary>
    /// Serializes and deserializes Jira request tokens so that they can be used by other application components.
    /// </summary>
    public class RequestTokenSerializer : IDataSerializer<RequestToken>
    {
        ...
        /// <returns>The jira request token</returns>
        ...
        /// <summary>
        /// Writes a jira request token as a series of bytes. Used by the <see cref="Serialize"/> method.
        /// </summary>
        ...
        /// <summary>
        /// Reads a jira request token from a series of bytes. Used by the <see cref="Deserialize"/> method.
        /// </summary>
        ...
        public static RequestToken Read(BinaryReader reader)
        {
            ...
            return new RequestToken { Token = token, TokenSecret = tokenSecret, Properties = properties };
        }
    }
}